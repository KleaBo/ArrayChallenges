...
// var result = highPass([6, 8, 3, 10, -2, 5, 9], 5); console.log(result); we expect back [6, 8, 10, 9] Given an array of numbers return a count of how many of the numbers are larger than the average.
...
// console.log(result); // we expect back 4.  Write a function that will reverse the values an array and return them.
